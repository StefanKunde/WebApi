...
namespace Microsoft.AspNetCore.Mvc.Core 
{
    ...
    internal class Resources {
        ...
        internal static global::System.Resources.ResourceManager ResourceManager {
            get {
                if (object.ReferenceEquals(resourceMan, null)) {
                    global::System.Resources.ResourceManager temp = new global::System.Resources.ResourceManager("Microsoft.AspNet.OData.Core3Internals.Mvc.Core.Resources", typeof(Resources).Assembly);
                    resourceMan = temp;
                }
                return resourceMan;
            }
        ...
        /// <summary>
        ///   Looks up a localized string similar to Action &apos;{0}&apos; does not have an attribute route. Action methods on controllers annotated with {1} must be attribute routed..
        /// </summary>
        internal static string ApiController_AttributeRouteRequired {
            get {
                return ResourceManager.GetString("ApiController_AttributeRouteRequired", resourceCulture);
            }
        }
        
        /// <summary>
        ///   Looks up a localized string similar to Action &apos;{0}&apos; has more than one parameter that was specified or inferred as bound from request body. Only one parameter per action may be bound from body. Inspect the following parameters, and use &apos;{1}&apos; to specify bound from query, &apos;{2}&apos; to specify bound from route, and &apos;{3}&apos; for parameters to be bound from body:.
        /// </summary>
        internal static string ApiController_MultipleBodyParametersFound {
            get {
                return ResourceManager.GetString("ApiController_MultipleBodyParametersFound", resourceCulture);
            }
        }
        
        /// <summary>
        ///   Looks up a localized string similar to Method {0} is decorated with the following attributes that are not allowed on an API convention method:{1}The following attributes are allowed on API convention methods: {2}..
        /// </summary>
        internal static string ApiConvention_UnsupportedAttributesOnConvention {
            get {
                return ResourceManager.GetString("ApiConvention_UnsupportedAttributesOnConvention", resourceCulture);
            }
        }
        
        /// <summary>
        ///   Looks up a localized string similar to Method name &apos;{0}&apos; is ambiguous for convention type &apos;{1}&apos;. More than one method found with the name &apos;{0}&apos;..
        /// </summary>
        internal static string ApiConventionMethod_AmbiguousMethodName {
            get {
                return ResourceManager.GetString("ApiConventionMethod_AmbiguousMethodName", resourceCulture);
            }
        }
        
        /// <summary>
        ///   Looks up a localized string similar to A method named &apos;{0}&apos; was not found on convention type &apos;{1}&apos;..
        /// </summary>
        internal static string ApiConventionMethod_NoMethodFound {
            get {
                return ResourceManager.GetString("ApiConventionMethod_NoMethodFound", resourceCulture);
            }
        }
        
        /// <summary>
        ///   Looks up a localized string similar to API convention type &apos;{0}&apos; must be a static type..
        /// </summary>
        internal static string ApiConventionMustBeStatic {
            get {
                return ResourceManager.GetString("ApiConventionMustBeStatic", resourceCulture);
            }
        }
        ...
        /// <summary>
        ///   Looks up a localized string similar to Each related assembly must be declared by exactly one assembly. The assembly &apos;{0}&apos; was declared as related assembly by the following:.
        /// </summary>
        internal static string ApplicationAssembliesProvider_DuplicateRelatedAssembly {
            get {
                return ResourceManager.GetString("ApplicationAssembliesProvider_DuplicateRelatedAssembly", resourceCulture);
            }
        }
        
        /// <summary>
        ///   Looks up a localized string similar to Assembly &apos;{0}&apos; declared as a related assembly by assembly &apos;{1}&apos; cannot define additional related assemblies..
        /// </summary>
        internal static string ApplicationAssembliesProvider_RelatedAssemblyCannotDefineAdditional {
            get {
                return ResourceManager.GetString("ApplicationAssembliesProvider_RelatedAssemblyCannotDefineAdditional", resourceCulture);
            }
        }
        
        /// <summary>
        ///   Looks up a localized string similar to Type {0} specified by {1} is invalid. Type specified by {1} must derive from {2}..
        /// </summary>
        internal static string ApplicationPartFactory_InvalidFactoryType {
            get {
                return ResourceManager.GetString("ApplicationPartFactory_InvalidFactoryType", resourceCulture);
            }
        }
        ...
        /// <summary>
        ///   Looks up a localized string similar to Could not create an instance of type &apos;{0}&apos;. Model bound complex types must not be abstract or value types and must have a parameterless constructor. Alternatively, give the &apos;{1}&apos; parameter a non-null default value..
        /// </summary>
        internal static string ComplexTypeModelBinder_NoParameterlessConstructor_ForParameter {
            get {
                return ResourceManager.GetString("ComplexTypeModelBinder_NoParameterlessConstructor_ForParameter", resourceCulture);
            }
        }
        ...
        internal static string ComplexTypeModelBinder_NoParameterlessConstructor_ForType {
            get {
                return ResourceManager.GetString("ComplexTypeModelBinder_NoParameterlessConstructor_ForType", resourceCulture);
            }
        }
        ...
        /// <summary>
        ///   Looks up a localized string similar to Invalid type parameter &apos;{0}&apos; specified for &apos;{1}&apos;..
        /// </summary>
        internal static string InvalidTypeTForActionResultOfT {
            get {
                return ResourceManager.GetString("InvalidTypeTForActionResultOfT", resourceCulture);
            }
        }
        ...
        /// <summary>
        ///   Looks up a localized string similar to Collection bound to &apos;{0}&apos; exceeded {1}.{2} ({3}). This limit is a safeguard against incorrect model binders and models. Address issues in &apos;{4}&apos;. For example, this type may have a property with a model binder that always succeeds. See the {1}.{2} documentation for more information..
        /// </summary>
        internal static string ModelBinding_ExceededMaxModelBindingCollectionSize {
            get {
                return ResourceManager.GetString("ModelBinding_ExceededMaxModelBindingCollectionSize", resourceCulture);
            }
        }
        
        /// <summary>
        ///   Looks up a localized string similar to Model binding system exceeded {0}.{1} ({2}). Reduce the potential nesting of &apos;{3}&apos;. For example, this type may have a property with a model binder that always succeeds. See the {0}.{1} documentation for more information..
        /// </summary>
        internal static string ModelBinding_ExceededMaxModelBindingRecursionDepth {
            get {
                return ResourceManager.GetString("ModelBinding_ExceededMaxModelBindingRecursionDepth", resourceCulture);
            }
        }
        ...
        /// <summary>
        ///   Looks up a localized string similar to Property &apos;{0}.{1}&apos; must be an instance of type &apos;{2}&apos;..
        /// </summary>
        internal static string Property_MustBeInstanceOfType {
            get {
                return ResourceManager.GetString("Property_MustBeInstanceOfType", resourceCulture);
            }
        }
        ...
        /// <summary>
        ///   Looks up a localized string similar to &apos;{0}&apos; requires a reference to &apos;{1}&apos;. Configure your application by adding a reference to the &apos;{1}&apos; package and calling &apos;{2}.{3}&apos; inside the call to &apos;{4}&apos; in the application startup code..
        /// </summary>
        internal static string ReferenceToNewtonsoftJsonRequired {
            get {
                return ResourceManager.GetString("ReferenceToNewtonsoftJsonRequired", resourceCulture);
            }
        }
        
        /// <summary>
        ///   Looks up a localized string similar to {0} specified on {1} cannot be self referential..
        /// </summary>
        internal static string RelatedAssemblyAttribute_AssemblyCannotReferenceSelf {
            get {
                return ResourceManager.GetString("RelatedAssemblyAttribute_AssemblyCannotReferenceSelf", resourceCulture);
            }
        }
        
        /// <summary>
        ///   Looks up a localized string similar to Related assembly &apos;{0}&apos; specified by assembly &apos;{1}&apos; could not be found in the directory {2}. Related assemblies must be co-located with the specifying assemblies..
        /// </summary>
        internal static string RelatedAssemblyAttribute_CouldNotBeFound {
            get {
                return ResourceManager.GetString("RelatedAssemblyAttribute_CouldNotBeFound", resourceCulture);
            }
        }
        ...
        /// <summary>
        ///   Looks up a localized string similar to Unexcepted end when reading JSON..
        /// </summary>
        internal static string UnexpectedJsonEnd {
            get {
                return ResourceManager.GetString("UnexpectedJsonEnd", resourceCulture);
            }
        }
        ...
        /// <summary>
        ///   Looks up a localized string similar to The relative page path &apos;{0}&apos; can only be used while executing a Razor Page. Specify a root relative path with a leading &apos;/&apos; to generate a URL outside of a Razor Page. If you are using {1} then you must provide the current {2} to use relative pages..
        /// </summary>
        ...
        internal static string ValidationProblemDescription_Title {
            get {
                return ResourceManager.GetString("ValidationProblemDescription_Title", resourceCulture);
            }
        }
        
        /// <summary>
        ///   Looks up a localized string similar to {0} exceeded the maximum configured validation depth &apos;{1}&apos; when validating type &apos;{2}&apos;..
        /// </summary>
        internal static string ValidationVisitor_ExceededMaxDepth {
            get {
                return ResourceManager.GetString("ValidationVisitor_ExceededMaxDepth", resourceCulture);
            }
        }
        
        /// <summary>
        ///   Looks up a localized string similar to This may indicate a very deep or infinitely recursive object graph. Consider modifying &apos;{0}.{1}&apos; or suppressing validation on the model type..
        /// </summary>
        internal static string ValidationVisitor_ExceededMaxDepthFix {
            get {
                return ResourceManager.GetString("ValidationVisitor_ExceededMaxDepthFix", resourceCulture);
            }
        }
        
        /// <summary>
        ///   Looks up a localized string similar to {0} exceeded the maximum configured validation depth &apos;{1}&apos; when validating property &apos;{2}&apos; on type &apos;{3}&apos;..
        /// </summary>
        internal static string ValidationVisitor_ExceededMaxPropertyDepth {
            get {
                return ResourceManager.GetString("ValidationVisitor_ExceededMaxPropertyDepth", resourceCulture);
            }
        }
        ...
        /// <summary>
        ///   Looks up a localized string similar to No file provider has been configured to process the supplied file..
        /// </summary>
        internal static string VirtualFileResultExecutor_NoFileProviderConfigured {
            get {
                return ResourceManager.GetString("VirtualFileResultExecutor_NoFileProviderConfigured", resourceCulture);
            }
        }
    }
}
