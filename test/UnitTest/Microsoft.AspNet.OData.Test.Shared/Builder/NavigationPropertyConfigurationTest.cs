    ...
    public class NavigationPropertyConfigurationTest
    {
        ...
        public void Ctor_ThrowsArgument_IfMultiplicityIsManyAndPropertyIsNotCollection()
        {
            ...
            ExceptionAssert.Throws<ArgumentException>(
                ...
                "The property 'ID' on the type 'T' is being configured as a Many-to-Many navigation property. Many to Many navigation properties must be collections." + ParamHelper.Text("property"));
        }
